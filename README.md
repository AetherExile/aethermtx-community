...
[![Join the Aether Exile Discord](https://img.shields.io/badge/Discord-JOIN%20THE%20AETHER%20EXILE%20COMMUNITY-5865F2?style=for-the-badge&logo=discord&logoColor=white)](https://discord.gg/KNd66FXtvw)
...
| 52 COMPLETE LOOKS | 279 BACK ATTACHMENTS | GGG STANDALONE | WINDOWS X64 |
| --- | --- | --- | --- |
...
| --- | --- |
| Version | `1.0.10` |
| File | `AetherMTX-Community-1.0.10.exe` |
| Size | `177455567` bytes |
| SHA-256 | `bb1bb6c3490960d7bc6f1139fce89ad79d3a69a9641be23d24dfd073fd78a9c4` |
| Signature | Not signed |
| Platform | Windows x64 |
| Game distribution | Standalone GGG client only |
...
Steam is not supported. AetherMTX Community Edition is designed only for the standalone Grinding Gear Games installation containing `Content.ggpk` and `PathOfExile.exe`.

## How it works

1. Install the standalone GGG Path of Exile 2 client.
2. Close Path of Exile 2 and its launcher.
3. Start AetherMTX Community Edition.
4. Select your standalone installation if it is not detected.
...
![AetherMTX Back Attachment preview inside the application](assets/back-attachment-preview.png)
